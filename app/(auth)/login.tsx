...
import { LogIn, UserPlus, Mail, Lock, Music, Eye, EyeOff } from 'lucide-react';
...
export default function LoginScreen() {
  ...
  const handleAuth = async () => {
    ...
    try {
      ...
      const msg = String(error?.message || 'Ocurrió un error inesperado.');
      const isNetworkError = /fetch|network|connect|supabase|timeout/i.test(msg);
      Alert.alert(
        'Error',
        isNetworkError
          ? 'No se pudo conectar con Supabase. Revisa tu conexión a internet o que el proyecto esté activo.'
          : msg
      );
    } finally {
      setLoading(false);
