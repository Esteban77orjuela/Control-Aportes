...
import { View, Text, TextInput, TouchableOpacity, StyleSheet, KeyboardAvoidingView, Alert, ScrollView } from 'react-native';
                ...
                if (phoneMatch) {
                    Alert.alert(
                        ...
                        [
                            ...
                            { text: 'Ir al Dashboard', onPress: () => router.back() }
                        ]
                    );
                    setLoading(false);
                    return;
