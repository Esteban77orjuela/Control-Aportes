...
import { Droplets, Package, TrendingUp, ShoppingCart, Plus, Minus, Trash2, PlusCircle, Eye, EyeOff } from 'lucide-react';
...
export default function BeverageDashboard() {
                ...
                { text: 'Cancelar', style: 'cancel' },
                {
                    ...
                    onPress: async () => {
                        try {
                            ...
                            loadData();
                            Alert.alert('Venta registrada', `Se vendió 1 ${beverage.name} por ${formatCurrency(beverage.salePrice)}.`);
                        } catch (e) {
                ...
                { text: 'Cancelar', style: 'cancel' },
                {
                    ...
                    onPress: async () => {
                        try {
                            ...
                            loadData();
                            Alert.alert('Eliminado', `"${beverage.name}" fue eliminado del inventario.`);
                        } catch (e) {
                ...
                <View style={styles.beverageRight}>
                    ...
                    <View style={styles.actionButtons}>
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() => router.push(`/beverages/refill?beverageId=${item.id}`)}
                        >
    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity
                style={styles.fab}
                onPress={() => router.push('/beverages/add')}
            >
