...
import { UserPlus, PiggyBank, Target, ArrowLeft, Search, Cake, Eye, EyeOff } from 'lucide-react';
        ...
        <ScrollView style={styles.container} contentContainerStyle={styles.content}>
            ...
            <View style={styles.actionRow}>
                <TouchableOpacity
                    ...
                    onPress={() => router.push('/retreat/new')}
                >
                ...
                <TouchableOpacity
                    ...
                    onPress={() => router.push('/retreat/register')}
                >
            ...
            {filteredYouths.map((youth: any) => (
                <TouchableOpacity 
                    ...
                    onPress={() => router.push(`/retreat/${youth.id}`)}
                >
