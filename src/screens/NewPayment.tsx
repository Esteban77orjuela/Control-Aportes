...
const styles = StyleSheet.create({
    ...
    formCard: { backgroundColor: '#fff', borderRadius: theme.borderRadius.l, padding: 20, ...theme.shadows.card },
    label: { fontSize: 14, fontWeight: '600', color: theme.colors.text, marginBottom: 8, marginTop: 10 },
    pickerTrigger: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', borderWidth: 1, borderColor: theme.colors.border, borderRadius: theme.borderRadius.s, padding: 12, backgroundColor: '#F9FAFB' },
    pickerText: { fontSize: 16, color: theme.colors.text },
    row: { flexDirection: 'row' },
    input: { borderWidth: 1, borderColor: theme.colors.border, borderRadius: theme.borderRadius.s, padding: 12, fontSize: 15, color: theme.colors.text, backgroundColor: '#F9FAFB' },
    datePickerButton: { flexDirection: 'row', alignItems: 'center', borderWidth: 1, borderColor: theme.colors.border, borderRadius: theme.borderRadius.s, padding: 12, backgroundColor: '#F9FAFB', gap: 10 },
    dateText: { fontSize: 15, color: theme.colors.text },
    signatureContainer: { height: 250, borderWidth: 1, borderColor: theme.colors.border, borderRadius: theme.borderRadius.s, overflow: 'hidden', marginTop: 5 },
    signatureCanvas: { flex: 1, width: '100%' },
    clearButton: { alignSelf: 'flex-end', padding: 8 },
    clearButtonText: { color: theme.colors.error, fontSize: 14 },
    saveButton: { backgroundColor: theme.colors.secondary, paddingVertical: 16, borderRadius: theme.borderRadius.m, alignItems: 'center', marginTop: 20, ...theme.shadows.default },
    ...
    searchContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#F3F4F6', margin: 15, paddingHorizontal: 15, borderRadius: 10, borderWidth: 1, borderColor: theme.colors.border },
    searchInput: { flex: 1, paddingVertical: 12, marginLeft: 10, fontSize: 16, color: theme.colors.text },
    modalTitle: { fontSize: 18, fontWeight: 'bold' },
    closeText: { color: theme.colors.primary, fontSize: 16 },
    pickerItem: { padding: 20, borderBottomWidth: 1, borderBottomColor: theme.colors.border, flexDirection: 'row', alignItems: 'center' },
    pickerItemText: { fontSize: 16, color: theme.colors.text },
    avatarSmall: { width: 32, height: 32, borderRadius: 16, backgroundColor: theme.colors.primary, justifyContent: 'center', alignItems: 'center', marginRight: 10 },
